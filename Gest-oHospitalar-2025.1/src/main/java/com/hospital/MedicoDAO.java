...
import java.sql.SQLException;  // Importando java.sql.Date
...
public class MedicoDAO {
    public static boolean inserirMedico(Medico medico) {
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            stmt.setDate(7, Date.valueOf(dataNascimento));  // Convertendo LocalDate para java.sql.Date
            
            stmt.setString(8, String.valueOf(medico.getSexo())); // Convertendo char para String
